...
import { toHex, hexToString, stringToHex } from "viem";
...
async function deployContract() {
    ...
    // https://hardhat.org/hardhat-runner/docs/advanced/-viem#contractsusing
    const ballotContract = await viem.deployContract("Ballot", [
        PROPOSALS.map((prop) => stringToHex(prop, { size: 32 })),
    ]);
